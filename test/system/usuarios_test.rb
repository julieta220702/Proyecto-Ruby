...
class UsuariosTest < ApplicationSystemTestCase
  ...
  test "should create usuario" do
    ...
    fill_in "Aniodenacimiento", with: @usuario.aniodenacimiento
    fill_in "Apellido", with: @usuario.apellido
    fill_in "Diadenacimiento", with: @usuario.diadenacimiento
    fill_in "Dni", with: @usuario.dni
    fill_in "Edad", with: @usuario.edad
    fill_in "Mesdenacimiento", with: @usuario.mesdenacimiento
